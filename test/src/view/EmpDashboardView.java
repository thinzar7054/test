...
public class EmpDashboardView extends JFrame {
	...
	public EmpDashboardView() {
		...
		textField.setBounds(97, 84, 456, 32);
		panel.add(textField);
		...
		btnNewButton.setBounds(583, 83, 85, 32);
		panel.add(btnNewButton);
		
		JButton btnAdd = new JButton("Add");
		btnAdd.setForeground(Color.WHITE);
		btnAdd.setBackground(Color.RED);
		btnAdd.setBounds(671, 84, 66, 32);
		panel.add(btnAdd);
	...
	private void createPanels() {
		...
		panels.put("EmployeeDashboard", createEmployeesDashboard());
	...
	private JPanel createEmployeesDashboard() {
		JPanel mainPanel = new JPanel(new BorderLayout());
		...
		JLabel dashboardLabel = new JLabel("Employee Dashboard");
